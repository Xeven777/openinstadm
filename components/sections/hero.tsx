...
export default function Hero() {
  return (
    ...
    >
      <div className="absolute right-45 w-100 z-20 hidden md:block">
      ...
      <div className="relative mx-auto flex min-h-130 w-full max-w-8xl items-center px-5 py-10 sm:min-h-140 sm:px-6 sm:py-14 lg:min-h-160 lg:px-8 lg:py-24 mt-15 xl:min-h-170">
        <div className="w-full max-w-160 xl:max-w-170">
          <p className="text-xs md:text-sm py-1 px-4 rounded-full w-fit tracking-wide shadow-lg border-2 inline-flex items-center gap-2 cursor-pointer bg-primary/15 text-lime-700 border-white/50 dark:bg-lime-400/10 dark:text-lime-300 dark:border-white/10 dark:shadow-[0_8px_32px_rgba(0,0,0,0.35),inset_0_1px_0_rgba(255,255,255,0.06)]">
          ...
          <h1 className="text-balance font-medium leading-[0.95] tracking-[-5%] xl:tracking-[-6.5%] text-foreground/90 dark:text-zinc-100">
            <span className="block text-3xl md:text-5xl lg:text-6xl xl:text-7xl">
              <span className="inline-flex items-baseline">
                ...
                <Image
                  ...
                  width={100}
                  height={100}
                  className="size-11 sm:size-12 translate-y-3 translate-x-2 sm:translate-y-5 sm:translate-x-3 lg:size-24 xl:size-24 scale-107 hover:scale-110 transition-transform duration-500 active:scale-100 active:translate-y-7 cursor-pointer dark:brightness-110"
                  style={{
            ...
            <span className="mt-1 flex flex-wrap items-center gap-x-2 md:gap-x-3 gap-y-1 text-3xl md:text-5xl lg:text-6xl xl:text-7xl">
              real
              <Image
                src={chatBubbles}
                alt="Chat Bubbles"
                className="size-9 translate-y-1 translate-x-2 sm:size-12 sm:translate-y-2 sm:translate-x-2.5 lg:size-15 xl:size-20 hover:scale-105 transition-transform duration-500 active:scale-x-95 active:translate-y-4 cursor-pointer brightness-110 dark:brightness-125 dark:drop-shadow-[0_8px_20px_rgba(132,204,22,0.25)]"
                width={100}
                height={100}
                style={{
