...
export const metadata: Metadata = {
  title: "Privacy Policy - OpenInstaDM",
  description:
    "How OpenInstaDM handles Instagram account data, webhook payloads, billing data, and customer campaign information.",
};
...
export default function PrivacyPage() {
  return (
    <LegalShell
      ...
      description="OpenInstaDM helps businesses send Meta-compliant private replies when people comment on connected Instagram posts or reels."
    ...
    >
      ...
      <section>
        ...
        <p className="mt-3">
          OpenInstaDM does not ask for Instagram passwords, scrape Instagram, or
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          the support email configured for the hosted OpenInstaDM service.
        </p>
      </section>
    </LegalShell>
  );
