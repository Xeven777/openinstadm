...
export const metadata: Metadata = {
  ...
  description:
    "Automate Instagram lead magnets: GUIDE, CHECKLIST, PLAN comments trigger tracked DM delivery. Follow-gate, CTR, playbooks for creators and coaches.",
  alternates: { canonical: "/instagram-lead-magnet-automation" },
  openGraph: {
    title: "Instagram Lead Magnet Automation — GUIDE Comments to Leads",
    description:
      "Turn guide/checklist comments into tracked DM leads. Follow-gate, analytics, and playbooks for creator funnels.",
