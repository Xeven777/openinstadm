...
export async function generateMetadata({
  ...
  if (!template) {
    return {
      title: "Template Not Found - OpenInstaDM",
    };
  }
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="border-b border-white/10 bg-zinc-950/55">
        <div className="mx-auto grid w-full max-w-8xl gap-10 px-5 py-14 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8 lg:py-20">
          <div>
            <Link
              href="/templates"
      ...
      <section className="mx-auto grid w-full max-w-8xl gap-8 px-5 py-16 sm:px-6 lg:grid-cols-[0.78fr_1.22fr] lg:px-8">
            ...
            <div className="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                <h2 className="text-2xl font-black text-white">
                  Copy this campaign into OpenInstaDM
                </h2>
